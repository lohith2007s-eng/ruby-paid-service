      ...
      data: {
        ...
        menu: {
          create: [
            ...
            { id: '4-2', name: 'Set Dosa', price: '60', img: '/images/south_indian_dish.jpg', desc: 'Spongey set of doses served with chutney and sagu.' },
            { id: '4-3', name: 'Rava Idli', price: '65', img: '/images/south_indian_dish.jpg', desc: 'Steamed semolina cake with veggies.' },
            { id: '4-4', name: 'Kesari Bath', price: '35', img: '/images/south_indian_dish.jpg', desc: 'Sweet semolina dessert.' },
            { id: '4-5', name: 'Khara Bath', price: '40', img: '/images/south_indian_dish.jpg', desc: 'Savory semolina porridge.' },
            { id: '4-6', name: 'Chow Chow Bath', price: '56', img: '/images/south_indian_dish.jpg', desc: 'Combination of Kesari Bath and Khara Bath.' },
          ]
        }
      }
    })
      ...
      data: {
        ...
        menu: {
          create: [
            ...
            { id: '5-4', name: 'Curd Rice', price: '65', img: '/images/south_indian_dish.jpg', desc: 'Creamy yogurt rice.' },
            { id: '5-5', name: 'Rava Idli', price: '65', img: '/images/south_indian_dish.jpg', desc: 'South Indian semolina steamed cake.' },
            { id: '5-6', name: 'Veg Palao', price: '135', img: '/images/veg_palao.jpg', desc: 'Spiced vegetable rice.' },
            { id: '5-7', name: 'Pongal', price: '65', img: '/images/south_indian_dish.jpg', desc: 'Comforting rice and lentil dish.' },
            { id: '5-8', name: 'Mini Meals', price: '75', img: '/images/south_indian_dish.jpg', desc: 'Assorted small portions of meals.' },
            { id: '5-9', name: 'Bisi Bele Bath', price: '65', img: '/images/south_indian_dish.jpg', desc: 'Spicy lentil rice dish.' },
            ...
            { id: '5-12', name: 'Chow Chow Bath', price: '76', img: '/images/south_indian_dish.jpg', desc: 'Sweet and savory semolina combo.' },
            { id: '5-13', name: 'Parota', price: '62', img: '/images/parota.jpg', desc: 'Layered flatbread.' },
            { id: '5-14', name: 'Palak Rice', price: '130', img: '/images/south_indian_dish.jpg', desc: 'Rice cooked with spinach.' },
            { id: '5-15', name: 'Butter Naan', price: '95', img: '/images/butter_naan.jpg', desc: 'Soft leavened bread with butter.' },
            { id: '5-16', name: 'Idli Vada', price: '78', img: '/images/south_indian_dish.jpg', desc: 'Steamed rice cake and savory donut.' },
            { id: '5-17', name: 'Full Meals', price: '115', img: '/images/south_indian_dish.jpg', desc: 'Complete South Indian meal.' },
            { id: '5-18', name: 'Bonda Soup', price: '48', img: '/images/veg_soup.jpg', desc: 'Savory fritter in lentil soup.' },
            { id: '5-19', name: 'Rice Bath', price: '70', img: '/images/south_indian_dish.jpg', desc: 'Flavorful spiced rice.' },
            ...
            { id: '5-24', name: 'Veg Mushroom Soup', price: '145', img: '/images/veg_soup.jpg', desc: 'Creamy mushroom and veg soup.' },
            { id: '5-25', name: 'Mushroom Noodles', price: '150', img: '/images/veg_noodles.jpg', desc: 'Noodles with mushrooms.' },
            { id: '5-26', name: 'Butter Kulcha', price: '60', img: '/images/butter_kulcha.jpg', desc: 'Soft bread with butter.' },
            { id: '5-27', name: 'Rava Dosa', price: '100', img: '/images/south_indian_dish.jpg', desc: 'Crispy semolina crepe.' },
            { id: '5-28', name: 'Jeera Rice', price: '150', img: '/images/jeera_rice.jpg', desc: 'Cumin flavored rice.' },
            { id: '5-29', name: 'Tomato Soup', price: '100', img: '/images/veg_soup.jpg', desc: 'Tangy tomato soup.' },
            { id: '5-30', name: 'Mini Dosa', price: '60', img: '/images/south_indian_dish.jpg', desc: 'Small size dosa.' },
            { id: '5-31', name: 'North Full Meals', price: '140', img: '/images/south_indian_dish.jpg', desc: 'Complete North Indian meal.' },
            { id: '5-32', name: 'Mushroom Rice', price: '130', img: '/images/south_indian_dish.jpg', desc: 'Rice cooked with mushrooms.' },
            { id: '5-33', name: 'Masala Dosa', price: '80', img: '/images/south_indian_dish.jpg', desc: 'Dosa with potato filling.' },
            ...
            { id: '5-36', name: 'Speacial Dosa', price: '105', img: '/images/south_indian_dish.jpg', desc: 'Chef specialty dosa.' },
